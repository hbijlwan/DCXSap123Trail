...
public class ConcertDaysUntilAttributeHandlerIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void testGetFutureConcertDate() throws Exception
	{
		...
		Assert.assertEquals("Wrong value for concert in the future: " + concert.getDaysUntil().longValue(), 2L,
				concert.getDaysUntil().longValue());
	}
	...
	public void testGetPastConcertDate() throws Exception
	{
		...
		Assert.assertEquals("Wrong value for concert in the past: " + concert.getDaysUntil().longValue(), 0L,
				concert.getDaysUntil().longValue());
	}
}